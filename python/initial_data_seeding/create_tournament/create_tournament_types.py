...
def run():
    ...
    with Session() as db_session:
        ...
        existing_tournament_types = (
            db_session.query(models.TournamentType.tournament_type_name)
            .filter(models.TournamentType.tournament_type_name.in_(TOURNAMENT_TYPES))
            .all()
        )
